<template>
  <div class="h-auto bg-white py-14">
    <div class="flex flex-col w-full h-full px-4">
      ...
      >
        ...
        <span
          ...
          >{{ $t("serviceDescription") }}</span
        >
      </div>

      <div
        class="grid w-full h-auto grid-cols-1 py-12 gap-y-2 md:grid-cols-2 lg:grid-cols-4 md:gap-4 lg:gap-8"
      >
        <ServiceItem
